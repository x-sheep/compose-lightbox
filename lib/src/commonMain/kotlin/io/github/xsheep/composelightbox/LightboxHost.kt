 ...
 */
@OptIn(ExperimentalLightboxApi::class)
@Composable
fun LightboxHost(
    ...
    CompositionLocalProvider(
        ...
        Box(
            ...
            if (currentPhoto != null) {
                ...
                val transformState = rememberTransformableState { _, zoomChange, rawPanChange, _ ->
                ...
                if (previousPhoto != null) {
                    AsyncImage(
                        ...
                        placeholder = rememberAsyncImagePainter(previousPhoto.thumbnail).takeIf {
                            previousPhoto.useThumbnailWhenLoading && previousPhoto.thumbnail != null
                                                                                                },
                    )
                }
                ...
                if (nextPhoto != null) {
                    AsyncImage(
                        ...
                        placeholder = rememberAsyncImagePainter(nextPhoto.thumbnail).takeIf {
                            nextPhoto.useThumbnailWhenLoading && nextPhoto.thumbnail != null
                        },
                    )
                }
                ...
                AsyncImage(
                    ...
                    placeholder = rememberAsyncImagePainter(currentPhoto.thumbnail).takeIf {
                        currentPhoto.useThumbnailWhenLoading && currentPhoto.thumbnail != null
                    },
                    onSuccess = {
                        val img = it.result.image
                        currentPhoto.aspectRatio = img.width.toFloat() / img.height.toFloat()
                    }
                )
            }
