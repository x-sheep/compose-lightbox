 ...
 */
@Composable
fun rememberLightboxState(key: Any? = null) = rememberSaveable(
    key, saver = LightboxSaver
) {
    LightboxState()
}
 ...
 */
@Serializable(with = LightboxStateSerializer::class)
class LightboxState internal constructor() {
    ...
    internal var targetIndex by mutableIntStateOf(0)
